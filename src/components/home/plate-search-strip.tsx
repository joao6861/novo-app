...
export function PlateSearchStrip() {
    ...
    return (
        <div className="w-full bg-premium-dark py-4">
            <div className="container mx-auto px-4">
                <div className="glass-premium relative overflow-hidden rounded-2xl border border-primary/20 px-6 py-4 shadow-[0_0_50px_-12px_rgba(0,145,255,0.3)] md:px-8">
                    {/* Decorative background glow */}
                    <div className="absolute -right-24 -top-24 h-64 w-64 rounded-full bg-primary/10 blur-3xl opacity-50" />
                    ...
                    <div className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                        ...
                        <div className="w-full lg:max-w-md">
                            <div className="relative flex flex-col gap-2 sm:flex-row sm:items-center bg-black/40 border border-white/10 p-1.5 rounded-xl focus-within:border-primary/50 transition-all shadow-inner">
                                <div className="relative flex-1">
                                    <Car className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-slate-500" />
                                    <input
                                        type="text"
                                        placeholder="PLACA (EX: ABC1234)"
                                        className="h-11 w-full border-none bg-transparent pl-10 pr-4 text-base font-black uppercase tracking-widest text-white placeholder:text-slate-700 outline-none focus:ring-0"
                                        value={plate}
